...
if test -e MediaArea_DV_Analyzer/Project/GNU/GUI/configure; then
 cd MediaArea_DV_Analyzer/Project/GNU/GUI/
 test -e Makefile && rm Makefile
 chmod u+x configure
...
# Going home
cd $Home
echo "MediaArea_DV_Analyzer executable is in MediaArea_DV_Analyzer/Project/GNU/GUI"
echo "For installing, cd MediaArea_DV_Analyzer/Project/GNU/GUI && make install"
