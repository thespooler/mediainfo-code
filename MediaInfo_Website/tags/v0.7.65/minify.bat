...
type css\normalize.css css\bootstrap.css css\jquery.fancybox.css css\jquery.fancybox-thumbs.css css\Style.css css\Tags.css | cleancss --s0 --selectors-merge-mode ie8 -o css\pack.css
