 ...
 else if (stristr($_SERVER['HTTP_USER_AGENT'], "linux"))
 {
    if (stristr($_SERVER['HTTP_USER_AGENT'], "debian"))
  {
   ...
   if (isset($OS_Version) and isset($CPU))
   {
    ...
    else if ($Link==$Language.'/Download/Debian#5.i386')        $Version='0.7.37';
    else if ($Link==$Language.'/Download/Debian#5.amd64')       $Version='0.7.37';
    $OS='Debian '.$OS_Version.', '.$CPU;
   }
   else
   {
    $Version='0.7.37'; //Debian
  ...
  else if (stristr($_SERVER['HTTP_USER_AGENT'], "ubuntu"))
  {
   ...
   if (isset($OS_Version) and isset($CPU))
   {
    ...
    else if ($Link==$Language.'/Download/Ubuntu#8.10.i386')     $Version='0.7.37';
    else if ($Link==$Language.'/Download/Ubuntu#8.10.amd64')    $Version='0.7.37';
    else if ($Link==$Language.'/Download/Ubuntu#9.04.i386')     $Version='0.7.37';
    else if ($Link==$Language.'/Download/Ubuntu#9.04.amd64')    $Version='0.7.37';
    else if ($Link==$Language.'/Download/Ubuntu#9.10.i386')     $Version='0.7.37';
    else if ($Link==$Language.'/Download/Ubuntu#9.10.amd64')    $Version='0.7.37';
    else if ($Link==$Language.'/Download/Ubuntu#10.04.i386')    $Version='0.7.37';
    else if ($Link==$Language.'/Download/Ubuntu#10.04.amd64')   $Version='0.7.37';
  ...
  else if (stristr($_SERVER['HTTP_USER_AGENT'], "centos"))
  {
   ...
   if (isset($OS_Version) and isset($CPU))
   {
    ...
    else if ($Link==$Language.'/Download/CentOS#5.i386')        $Version='0.7.37';
    else if ($Link==$Language.'/Download/CentOS#5.x86_64')      $Version='0.7.37';
    $OS='CentOS '.$OS_Version.', '.$CPU;
   }
   else
   {
    $Version='0.7.37'; //CentOS
  ...
  else if (stristr($_SERVER['HTTP_USER_AGENT'], "red hat"))
  {
   ...
   if (isset($OS_Version) and isset($CPU))
   {
    ...
    else if ($Link==$Language.'/Download/RHEL#5.i386')        $Version='0.7.37';
    else if ($Link==$Language.'/Download/RHEL#5.x86_64')      $Version='0.7.37';
  ...
  else if (stristr($_SERVER['HTTP_USER_AGENT'], "fedora"))
  {
   ...
   if (isset($OS_Version) and isset($CPU))
   {
    ...
    else if ($Link==$Language.'/Download/Fedora#12.i386')       $Version='0.7.37';
    else if ($Link==$Language.'/Download/Fedora#12.x86_64')     $Version='0.7.37';
    else if ($Link==$Language.'/Download/Fedora#13.i386')       $Version='0.7.37';
    else if ($Link==$Language.'/Download/Fedora#13.x86_64')     $Version='0.7.37';
  ...
  else if (stristr($_SERVER['HTTP_USER_AGENT'], "suse"))
  {
   ...
   if (isset($OS_Version) and isset($CPU))
   {
    $Link=$Language.'/Download/openSUSE#'.$OS_Version.'.'.$CPU;
         if ($Link==$Language.'/Download/openSUSE#11.3.i586')   $Version='0.7.37';
    else if ($Link==$Language.'/Download/openSUSE#11.3.x86_64') $Version='0.7.37';
    $OS='openSUSE '.$OS_Version.', '.$CPU;
   }
   else
   {
    $Version='0.7.37'; //openSUSE
  ...
  else if (stristr($_SERVER['HTTP_USER_AGENT'], "mandriva"))
  {
   ...
   if (isset($OS_Version) and isset($CPU))
   {
    ...
    else if ($Link==$Language.'/Download/Mandriva#2009.1.i586')   $Version='0.7.37';
    else if ($Link==$Language.'/Download/Mandriva#2009.1.x86_64') $Version='0.7.37';
    else if ($Link==$Language.'/Download/Mandriva#2010.i586')   $Version='0.7.37';
    else if ($Link==$Language.'/Download/Mandriva#2010.x86_64') $Version='0.7.37';
    else if ($Link==$Language.'/Download/Mandriva#2010.1.i586')   $Version='0.7.37';
    else if ($Link==$Language.'/Download/Mandriva#2010.1.x86_64') $Version='0.7.37';
    $OS='Mandriva '.$OS_Version.', '.$CPU;
   }
   else
   {
    $Version='0.7.37'; //Mandriva
